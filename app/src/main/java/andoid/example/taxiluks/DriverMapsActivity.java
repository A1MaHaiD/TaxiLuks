...
public class DriverMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private static final int CHECK_SETTINGS_CODE = 128;
    private static final int REQUEST_LOCATION_PERMISSION = 129;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingsButton = findViewById(R.id.driverSettingsButton);
        singOutButton = findViewById(R.id.driverSignInButton);
    ...
    private void updateLocationUi() {
        ...
        if (currentLocation != null) {
            ...
            LatLng driverLocationUpdate = new LatLng(
                    currentLocation.getLatitude(),
                    currentLocation.getLongitude());
            mMap.moveCamera(CameraUpdateFactory.newLatLng(driverLocationUpdate));
            mMap.animateCamera(CameraUpdateFactory.zoomTo(12));
            mMap.addMarker(new MarkerOptions().position(driverLocationUpdate).title("Driver location"));
