...
public class PassengerMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private static final int CHECK_SETTINGS_CODE = 130;
    private static final int REQUEST_LOCATION_PERMISSION = 131;
    ...
    boolean isLocationUpdatesActive;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingsButton = findViewById(R.id.passengerSettingsButton);
        singOutButton = findViewById(R.id.passengerSignInButton);
        bookTaxiButton = findViewById(R.id.bookTaxiButton);

        driversGeoFire = FirebaseDatabase.getInstance()
                .getReference()
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        switch (statusCode) {
                            ...
                            case LocationSettingsStatusCodes
                                ...
                                String message = "Adjust location settings on you device";
            ...
            case CHECK_SETTINGS_CODE:
                switch (resultCode) {
                    ...
                    case Activity.RESULT_CANCELED:
                        Log.d("MainActivity", "User has'n agreed to change location "
                                + "settings");
                        isLocationUpdatesActive = false;
                        updateLocationUi();
                        break;
    ...
    private void updateLocationUi() {
        ...
        if (currentLocation != null) {
            ...
            LatLng passengerLocationUpdate = new LatLng(
                    currentLocation.getLatitude(),
                    currentLocation.getLongitude());
            mMap.moveCamera(CameraUpdateFactory.newLatLng(passengerLocationUpdate));
            mMap.animateCamera(CameraUpdateFactory.zoomTo(12));
            mMap.addMarker(new MarkerOptions().position(passengerLocationUpdate).title("Passenger location"));
